const Map<String, String> bsTranslations = {
  ...
  // Ranking Screen
  'reset_wins': 'RESETUJ POBJEDE?',
  'reset_wins_warning':
      'Ovo će obrisati sve pobjede igrača. Ova radnja se ne može poništiti.',
  'reset': 'RESET',

  // Tracking Screen
  'points_tracker': 'PRAĆENJE BODOVA',
  'no_rounds': 'NEMA RUNDI',
  'add_round': 'DODAJ RUNDU',
  'finish': 'ZAVRŠI',
  'add_point': 'DODAJ BOD',
  'complete': 'ZAVRŠI',
  'exit_game': 'IZAĐI IZ IGRE?',
  'exit_game_warning':
      'Imate runde u toku. Da li ste sigurni da želite izaći? Sav napredak će biti izgubljen.',
  'exit': 'IZAĐI',
  'finish_game': 'ZAVRŠI IGRU?',
  'finish_game_confirm':
      'Da li ste sigurni da želite završiti igru i proglasiti pobjednika?',
  'remove_player': 'UKLONI IGRAČA?',
  'remove_player_confirm': 'iz igre? Ova radnja se ne može poništiti.',
  'remove': 'UKLONI',
  'minimum_players_required': 'Potrebna su minimalno 2 igrača',
  'player_removed': 'uklonjen/a',
  'add_player': 'DODAJ IGRAČA',
  'add_new_player': 'DODAJ NOVOG IGRAČA',
  'select_existing_player': 'ODABERI POSTOJEĆEG',
  'no_available_players': 'Svi igrači su već u sesiji',
  'player_added': 'dodan/a u sesiju',
  'edit_score': 'UREDI BOD',
  'score_updated': 'Bod ažuriran',
  'or_divider': 'ILI',
  'create_new': 'KREIRAJ NOVOG',

  // Win Screen
  'winner': 'POBJEDNIK',
  'session_rankings': 'RANG LISTA SESIJE',
  'return_home': 'NAZAD NA POČETAK',
